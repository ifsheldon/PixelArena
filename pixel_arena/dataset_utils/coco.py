...
You can first recognize all categories of all subjects in the first image and then draw the mask. Note that the first category `other` is used only when there're no suitable category labels for a subject in the image.
"""
